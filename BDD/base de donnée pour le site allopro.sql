...
-- Listage des données de la table basesitebtp.orders : ~11 rows (environ)
REPLACE INTO `orders` (`id`, `user_id`, `total_amount`, `order_date`, `status`) VALUES
	...
	(8, 7, 389.97, '2025-05-09 12:51:16', 'confirmée'),
	(9, 8, 55.99, '2025-05-09 13:29:08', 'confirmée'),
	(10, 3, 55.89, '2025-05-09 14:11:41', 'confirmée'),
	(11, 9, 149.70, '2025-05-09 15:39:14', 'confirmée');
...
-- Listage des données de la table basesitebtp.order_items : ~15 rows (environ)
...
CREATE TABLE IF NOT EXISTS `users` (
  ...
  `role` enum('client','professionnel','admin') COLLATE utf8mb4_unicode_ci NOT NULL,
...
-- Listage des données de la table basesitebtp.users : ~7 rows (environ)
REPLACE INTO `users` (`id`, `email`, `pwd`, `username`, `role`, `date`, `modification`, `status`, `login_attempts`, `last_attempt_time`) VALUES
	...
	(3, 'test@gmail.com', '$2y$10$1TM.N22UtgGX5rnKEDoZe.xSLJyFzg1/Dzv3MGonrWnmzBSLrz/oa', 'test@gmail.com', 'admin', '2025-05-03 13:42:28', '2025-05-12 11:59:11', 'active', 0, NULL),
	(4, 'test3@gmail.com', '$2y$10$yQusu1UA.v5beFgUxCAIkO8rsZdL2I25xVg5K/VVPo1MjgegshB9W', 'test3', 'client', '2025-05-06 11:39:42', '2025-05-06 11:39:42', 'active', 0, NULL),
	(5, 'adam0@gmail.com', '$2y$10$n4/xdhDowbIhXel/USu0EekXeEklF9aSZi5NMZcXD5e98ZiaueFnu', 'adam0', 'client', '2025-05-07 17:29:18', '2025-05-07 17:29:18', 'active', 0, NULL),
	(7, 'test5@gmail.com', '$2y$10$n6tWkuJyYi6uG8niZN5bBOPIv3hrutsU0VApUcUMWj.89QOcCrThe', 'test5', 'client', '2025-05-09 12:50:29', '2025-05-09 12:50:29', 'active', 0, NULL),
	(8, 'yanis@gmail.com', '$2y$10$Ybmy.EM1RYzGcOKMnN1AH.exGdEVD2ianJ.xAVz2vhQoGlZPwDa8S', 'yani', 'client', '2025-05-09 13:28:30', '2025-05-09 13:28:30', 'active', 0, NULL),
	(9, 'adammmm@gmail.com', '$2y$10$WxzPGCVcpTc3difwsLajFeII/NjjkCQUCtDcRG5yNnz2v68U4MKC2', 'adammmm', 'client', '2025-05-09 15:37:29', '2025-05-09 15:37:29', 'active', 0, NULL);
